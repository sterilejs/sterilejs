...
namespace Oxide.Plugins
{
    ...
    class GatherManager : RustPlugin
    {
        ...
        // Plugin options
        private static readonly Dictionary<string, object> DefaultGatherResourceModifiers = new Dictionary<string, object>(5);
        private static readonly Dictionary<string, object> DefaultGatherDispenserModifiers = new Dictionary<string, object>(5);
        private static readonly Dictionary<string, object> DefaultQuarryResourceModifiers = new Dictionary<string, object>(5);
        private static readonly Dictionary<string, object> DefaultPickupResourceModifiers = new Dictionary<string, object>(5);
        private static readonly Dictionary<string, object> DefaultSurveyResourceModifiers = new Dictionary<string, object>(5);
        ...
        private const string DefaultModifyResource = "You have set the gather rate for {tree} to x{5} from {1}.";
        private const string DefaultModifyResourceRemove = "You have reset the gather rate for {tree} from {1}.";
        private const string DefaultModifySpeed = "The Mining Quarry will now provide resources every {30} seconds.";
        ...
        private const string DefaultModifyDispenser = "You have set the resource amount for {ore} dispensers to x{5}";
        ...
        private const string DefaultHelpTextPlayerGains = "Resources gained from {5}:";
        private const string DefaultHelpTextPlayerMiningQuarrySpeed = "Time between Mining Quarry gathers: {30} second(s).";
        ...
        private void Gather(BasePlayer player, string command, string[] args)
        {
            ...
            if (GatherResourceModifiers.Count == 5 && SurveyResourceModifiers.Count == 5 && PickupResourceModifiers.Count == 5 && QuarryResourceModifiers.Count == 5)
                help += HelpTextPlayerDefault;
            else
            {
                if (GatherResourceModifiers.Count > 5)
                {
                ...
                if (PickupResourceModifiers.Count > 5)
                {
                ...
                if (QuarryResourceModifiers.Count > 5)
                {
                ...
                if (ExcavatorResourceModifiers.Count > 5)
                {
                ...
                if (SurveyResourceModifiers.Count > 5)
                {
